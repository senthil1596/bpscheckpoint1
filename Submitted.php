		...
		<div class="row">
			...
			<div class="col-md-10"><br>
				...
				<div class="pull-right" style="float:right;">
					...
					<a href="#" class="btn btn-primary">Generate Letter</a>
					<a href="#" class="btn btn-primary">Post to SAP</a>
				...
				<table class="table table-responsive table-borderless text-center" style="font-size:10px;">
						<thead>
							<tr>
								...
								<th colspan="3" class="align-middle">Action</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="align-middle"><input type="checkbox" class="form-control"><b><a href="EmployeeDetails.php">370571</a></b></td>
								...
								<td class="align-middle"><a class="btn btn-xs" href="#"><span class="fa fa-eye"></span></a></td>
								<td class="align-middle"><a class="btn btn-xs" href="#"><span class="fa fa-times"></span></a></td>
							</tr>
							<tr>
								<td class="align-middle"><input type="checkbox" class="form-control"><b><a href="EmployeeDetails.php">370571</a></b></td>
								<td class="align-middle">Senthil Kumar</td>
