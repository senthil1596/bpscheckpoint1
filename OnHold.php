		...
		<div class="row">
			...
			<div class="col-md-10"><br>
				...
				<table class="table table-responsive table-borderless text-center" style="font-size:10px;">
						...
						<tbody>
							<tr>
								<td class="align-middle"><input type="checkbox" class="form-control"><b><a href="OnHoldSalaryDetails.php">370571</a></b></td>
								...
								<td class="align-middle"><a class="btn btn-xs" href="#"><span class="fa fa-trash"></span></a></td>
							</tr>
							<tr>
								<td class="align-middle"><input type="checkbox" class="form-control"><b><a href="OnHoldSalaryDetails.php">370571</a></b></td>
								<td class="align-middle">Senthil Kumar</td>
